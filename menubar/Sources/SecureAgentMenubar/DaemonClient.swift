...
public final class DaemonClient: Sendable {
    ...
    public func fetchMutes() async throws -> [(rule: String, host: String, agent: String?)] {
    ...
    static func parseMutes(_ data: Data) throws -> [(rule: String, host: String, agent: String?)] {
