...
### Changed
- Console Overview: Memory by session is Memory by family — one bar per live process family, its RSS counted once, `N sessions` in the label; the badge counts families.
